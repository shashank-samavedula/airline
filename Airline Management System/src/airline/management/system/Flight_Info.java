...
public class Flight_Info extends JFrame{  //Second Frame
    ...
    JLabel FlightDetails = new JLabel("FLIGHT SEARCH");
    ...
    btnShow.setFont(new Font("Tahoma", Font.PLAIN, 20));
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "select f_code,f_name,src,dst,capacity,class_code,class_name from flight ,sector where f_code = '"+code+"' and flight_code = '"+code+"'";
